/**
 * Canonical Thinking & Reasoning Data Types for Next.js and React Frontend.
 *
 * Defines the real-time reasoning milestone event contract streamed from
 * backend/rag/thinking.py and backend/services/chat_service.py.
 */
